...
$sql="INSERT INTO `transaction`(`firstname`, `email`, `phone`, `amount`, `txnid`) VALUES ('$firstname','$email','$phone','$amount','$txnid')";
if(mysqli_query($conn,$sql)){
	echo "<script>alert('Successfully transaction!!!');location.href='index.php'</script>";
}
else{
	echo "<script>alert('There is an error to access database');location.href='transaction.php'</script>";
}

	$hashseq=$MERCHANT_KEY.'|'.$txnid.'|'.$amount.'|'.$firstname.'|'.$email.'|||||||||||'.$SALT;
